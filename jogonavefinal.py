...
musica_de_fundo = pygame.mixer.music.load('animation-master/triangulinho.mp3')
pygame.mixer.music.play(-1)

xarope = pygame.mixer.Sound('animation-master/eb.wav')
encostovini= pygame.mixer.Sound('animation-master/encostanovni.wav')
acertaovini = pygame.mixer.Sound('animation-master/xaropinho.wav')
atirando = pygame.mixer.Sound('animation-master/tome.wav')
